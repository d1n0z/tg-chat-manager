...
class Chat(Model):
    ...
    cluster = fields.ForeignKeyField("models.Cluster", related_name="chats", null=True, on_delete=fields.CASCADE)
...
class UserRole(Model):
    ...
    chat = fields.ForeignKeyField("models.Chat", related_name="user_roles", on_delete=fields.CASCADE)
    level = fields.CharEnumField(enums.Role, default=enums.Role.user)
    assigned_by = fields.ForeignKeyField("models.User", related_name="assigned_roles", null=True, on_delete=fields.SET_NULL)
...
class InviteLink(Model):
    ...
    chat = fields.ForeignKeyField("models.Chat", related_name="invite_links", on_delete=fields.CASCADE)
    creator = fields.ForeignKeyField("models.User", related_name="created_invites", null=True, on_delete=fields.SET_NULL)
...
class InviteUsage(Model):
    ...
    id = fields.IntField(primary_key=True)
    invite = fields.ForeignKeyField("models.InviteLink", related_name="usages", on_delete=fields.CASCADE)
    user = fields.ForeignKeyField("models.User", related_name="invite_usages", null=True, on_delete=fields.SET_NULL)
...
class Mute(Model):
    ...
    id = fields.IntField(primary_key=True)
    user = fields.ForeignKeyField("models.User", related_name="mutes", on_delete=fields.CASCADE)
    chat = fields.ForeignKeyField("models.Chat", related_name="mutes", on_delete=fields.CASCADE)
    start_at = fields.DatetimeField(auto_now_add=True)
    end_at = fields.DatetimeField(null=True)
    reason = fields.TextField(null=True)
    created_by = fields.ForeignKeyField("models.User", related_name="created_mutes", null=True, on_delete=fields.SET_NULL)
...
class GlobalBan(Model):
    ...
    id = fields.IntField(primary_key=True)
    user = fields.ForeignKeyField("models.User", related_name="global_bans", on_delete=fields.CASCADE)
    cluster = fields.ForeignKeyField("models.Cluster", related_name="global_bans", null=True, on_delete=fields.CASCADE)
    reason = fields.TextField(null=True)
    created_by = fields.ForeignKeyField("models.User", related_name="created_global_bans", null=True, on_delete=fields.SET_NULL)
    created_at = fields.DatetimeField(auto_now_add=True)
    active = fields.BooleanField(default=True)
    lifted_by = fields.ForeignKeyField("models.User", related_name="lifted_global_bans", null=True, on_delete=fields.SET_NULL)
...
class WelcomeMessage(Model):
    ...
    id = fields.IntField(primary_key=True)
    cluster = fields.ForeignKeyField("models.Cluster", related_name="welcome_message", null=True, on_delete=fields.CASCADE)
    text = fields.TextField()
    created_by = fields.ForeignKeyField("models.User", related_name="created_welcomes", null=True, on_delete=fields.SET_NULL)
    created_at = fields.DatetimeField(auto_now_add=True)
...
class MessagePin(Model):
    ...
    id = fields.IntField(primary_key=True)
    chat = fields.ForeignKeyField("models.Chat", related_name="pins", on_delete=fields.CASCADE)
    message_id = fields.BigIntField()
    pinned_by = fields.ForeignKeyField("models.User", related_name="pins_created", null=True, on_delete=fields.SET_NULL)
...
class NewsBroadcast(Model):
    ...
    id = fields.IntField(primary_key=True)
    cluster = fields.ForeignKeyField("models.Cluster", related_name="news_broadcasts", null=True, on_delete=fields.CASCADE)
    actor = fields.ForeignKeyField("models.User", related_name="news_actions", null=True, on_delete=fields.SET_NULL)
...
class LogEntry(Model):
    ...
    id = fields.IntField(primary_key=True)
    cluster = fields.ForeignKeyField("models.Cluster", related_name="logs", null=True, on_delete=fields.CASCADE)
    chat = fields.ForeignKeyField("models.Chat", related_name="logs", null=True, on_delete=fields.CASCADE)
    action = fields.CharField(max_length=64, description="Например: GBAN, GKICK, MUTE")
    target_user = fields.ForeignKeyField("models.User", related_name="target_logs", null=True, on_delete=fields.SET_NULL)
    actor_user = fields.ForeignKeyField("models.User", related_name="actor_logs", null=True, on_delete=fields.SET_NULL)
    reason = fields.TextField(null=True)
    meta = fields.JSONField(null=True)
    created_at = fields.DatetimeField(auto_now_add=True)
...
class ChatSetting(Model):
    id = fields.IntField(primary_key=True)
    chat = fields.ForeignKeyField("models.Chat", related_name="settings_rows", on_delete=fields.CASCADE)
...
class ClusterSetting(Model):
    id = fields.IntField(primary_key=True)
    cluster = fields.ForeignKeyField("models.Cluster", related_name="settings_rows", on_delete=fields.CASCADE)
    key = fields.CharField(max_length=128)
    value = fields.JSONField(null=True)
